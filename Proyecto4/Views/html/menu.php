      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="hoteles/hoteles.php" target="base" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
                <span class="hide-menu">Hoteles</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="reservas/reservas.php" target="base" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="clientes/clientes.php" target="base" aria-expanded="false">
                <span>
                  <i class="ti ti-file-description"></i>
                </span>
